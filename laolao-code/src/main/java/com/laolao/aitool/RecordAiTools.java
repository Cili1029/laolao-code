...
public class RecordAiTools {
    ...
    public AdvisorExamReportContent queryClassExamFullData(@ToolParam(description = "这一场考试的主键") Integer examId) {
        // 查成绩和考勤
        ...
        // 查全班实际作答代码
        List<MemberAnswerDataContent> answers = judgeRecordMapper.selectMemberAnswersByExamId(examId);
        return AdvisorExamReportContent.builder()
                .attendanceAndScores(scores)
                .examQuestions(questions)
                .memberAnswers(answers)
                .build();
    }
