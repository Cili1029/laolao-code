...
public class ExamConstant {
    ...
    public static final int PUBLISHING = 5;    // 发布中（正在进行异步判题校验）
    public static final int PUBLISHED = 1;     // 已发布状态（考试对外可见，可参与）
    public static final int GRADING = 2; // 已结束/改卷中状态（考试答题阶段结束，正在AI/人工改卷）
    public static final int COMPLETED = 3; // 已改完状态（所有试卷批改完毕，可查看成绩）
