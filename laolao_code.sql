...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI分析报告表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '考试题目分值配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `judge_record`  (
  ...
  `question_id` int NOT NULL COMMENT '题目ID',
  `status` tinyint NOT NULL DEFAULT -1 COMMENT '状态(-1-判题中, 0-AC, 1-WA, 2-MLE, 3-TLE, 4-RE, 5-CE, 6-SE, 7-UN)',
  `score` int NOT NULL DEFAULT 0 COMMENT '得分',
  `answer_code` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '代码快照',
  `error_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '编译错误/系统异常',
  `total_count` int NOT NULL DEFAULT 0 COMMENT '测试示例总数',
  `pass_count` int NOT NULL DEFAULT 0 COMMENT '测试示例通过数',
  `failed_input` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '未通过的的测试示例输入',
  `failed_expect` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '未通过的的测试示例预期输出',
  `failed_actual` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '未通过的的测试示例实际输出',
  `time` int NULL DEFAULT NULL COMMENT '执行耗时(ms)',
  `memory` int NULL DEFAULT NULL COMMENT '内存消耗(KB)',
  `submit_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 39 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '考生判题记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 44 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '考生考试最终判题结果汇总表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `question`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '题目表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `question_favorite`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` int NOT NULL COMMENT '用户ID (教师ID)',
  `question_id` int NOT NULL COMMENT '题目ID',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '收藏时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_question`(`user_id` ASC, `question_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '题目收藏表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `question_test_case`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 103 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '题目测试用例表' ROW_FORMAT = Dynamic;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'advisor1', '李教授', 'E10ADC3949BA59ABBE56E057F20F883E', 1, 1);
INSERT INTO `user` VALUES (2, 'member1', '劳劳', 'E10ADC3949BA59ABBE56E057F20F883E', 2, 1);
INSERT INTO `user` VALUES (3, 'member2', '欣欣', 'E10ADC3949BA59ABBE56E057F20F883E', 2, 1);
INSERT INTO `user` VALUES (4, 'admin', '项目管理员', 'E10ADC3949BA59ABBE56E057F20F883E', 0, 1);
