...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '成员判题最终成绩汇总表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of judge_member_result
-- ----------------------------
INSERT INTO `judge_member_result` VALUES (1, 2, 2, 2, 2, 58, 0, 1, '2026-04-06 14:31:47');
...
CREATE TABLE `judge_record`  (
  ...
  `submit_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '提交时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 59 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '判题记录' ROW_FORMAT = Dynamic;
